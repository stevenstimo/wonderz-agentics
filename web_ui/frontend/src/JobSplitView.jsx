          ...
          <div className="flex-1 overflow-y-auto p-4">
            {!job && (
              <div className="text-slate-500 text-sm py-8">
                Describe your task on the left. The CEO will create a plan for you.
              </div>
            )}
              ...
              return (
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-slate-600">
                    {allPending ? 'Execution is starting… Steps will show "In progress" and "Done" as they run. You can keep chatting with the CEO on the left.' : 'Assigned agents run each step in order. Status updates every 5 seconds.'}
                  </p>
