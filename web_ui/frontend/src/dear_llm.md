...
## KRITIEK: app/main.py bescherming
Lees app/main.py ALTIJD volledig voor je het aanpast.
Verwijder NOOIT de config import, routers, of health endpoint.
Zie bovenstaande lijst voor alle verplichte code.
