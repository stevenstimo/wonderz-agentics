-- Migration: Skills Tag Data — apply lifecycle_stage, agent_role, use_case from registry
-- Data-only: assumes columns exist (run 030 first). Re-runnable to sync tag data.
-- Run: psql "$DATABASE_URL" -f migrations/031_skills_tag_data.sql

-- Skills built in this session (explicit registry)
